...
WIS: 55
```
It returned the starting values! If we can modify the `FLAG` value to 100, re-encode the value and set that as our cookie, we should get the flag! We can do the oposite of the decoding we just did!
